(function (global, factory) {
    ...
    // Firebase does the parsing for us, so we have to remove it
    ...
    var seedData = {
    	...
    	comments: {
            ...
            "7f1d469a-4df4-4f79-aa81-309f472b5518": {
    			_ownerId: "60f0cf0b-34b0-4abd-9769-8c42f830dffc",
    			text: "Looks amazing!",
    			productId: "3564027f-adcd-4425-b2c0-1253d2386c0c",
    			_createdOn: 1701985301768,
    ...
    // This part automatically starts the server. Firebase does this for us, so we have to remove it
    // const port = 3030;
    // server.listen(port);
